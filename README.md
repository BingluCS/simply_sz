...
$1.10010000_{(2)}... \times 2^6$ and
$1.10010000..._{(2)} \times 2^6}$ and $1.00001100..._{(2)}×2^{−10}$ numbers,  then the leading mantissa bits for the two numbers are supposed to be no less than $6−(−12)=18$ bits and $−10−(−12)=2$ bits respectively. Obviously, the latter requires much less bits to meet the required precision.
